...
public sealed class Review : Entity
{
    ...
    private Review(Guid propertyId, Guid userId, int rating, string comment) : this()
    {
    ...
    public static Review Create(Guid propertyId, Guid userId, int rating, string comment)
        => new Review(propertyId, userId, rating, comment);
